...
const testimonials = [
  {
    ...
    text: 'HabitFlow completely changed my morning routine. The streak feature keeps me so accountable - I haven\'t missed a day in 45 days!',
    streak: 45,
  ...
  },
  {
    ...
    role: 'Fitness Coach',
    text: 'Dotti is adorable and makes habit tracking actually fun! My clients love how easy it is to build consistent routines.',
    streak: 67,
