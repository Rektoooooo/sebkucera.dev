      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div className="footer-top">
          ...
          <div style={{ maxWidth: '300px' }}>
            ...
            <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '24px' }}>
              Build better habits, one day at a time. Track, grow, and achieve your goals with Dotti by your side.
            </p>
            {/* Social links */}
        ...
        <div className="footer-bottom" style={{ marginTop: '60px' }}>
          <p style={{ fontSize: '14px', color: 'var(--text-secondary)' }}>
            © {new Date().getFullYear()} HabitFlow. Made with 💜 by Sebastian Kucera
          </p>
          <a
