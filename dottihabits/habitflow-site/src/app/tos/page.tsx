        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <Section title="Agreement to Terms">
              <p>
                By downloading, installing, or using HabitFlow, you agree to be bound by these Terms of Service.
            ...
            <Section title="Description of Service">
              <p>
                HabitFlow is a habit tracking application for iOS devices that helps users build and maintain
            ...
            <Section title="User Accounts and Subscriptions">
              <p>
                HabitFlow offers both free and premium subscription tiers. Premium features are available through
                in-app purchases:
              </p>
              <ul>
            ...
            <Section title="Acceptable Use">
              <p>You agree to use HabitFlow only for lawful purposes and in accordance with these Terms. You agree not to:</p>
              <ul>
            ...
            <Section title="Intellectual Property">
              <p>
                HabitFlow and its original content, features, and functionality are owned by Sebastian Kucera
                and are protected by international copyright, trademark, and other intellectual property laws.
                The HabitFlow name, logo, and Dotti mascot are trademarks of Sebastian Kucera.
              </p>
            </Section>

            <Section title="Health Data Disclaimer">
              <p>
                HabitFlow integrates with Apple Health to help you track health-related habits. However,
                HabitFlow is not a medical device and should not be used as a substitute for professional
            ...
            <Section title="Limitation of Liability">
              <p>
                To the maximum extent permitted by law, HabitFlow and its developer shall not be liable for
            ...
            <Section title="Disclaimer of Warranties">
              <p>
                HabitFlow is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, either
            ...
            <Section title="Changes to Terms">
              <p>
                ...
                any material changes by updating the &quot;Last updated&quot; date. Your continued use of HabitFlow
            ...
            <Section title="Termination">
              <p>
                We may terminate or suspend your access to HabitFlow immediately, without prior notice, for
