        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            <Section title="Introduction">
              <p>
                Welcome to HabitFlow. We respect your privacy and are committed to protecting your personal data.
            ...
            <Section title="Information We Collect">
              <p>HabitFlow collects the following types of information:</p>
              <ul>
            ...
            <Section title="How We Use Your Information">
              ...
              <ul>
                <li>Provide and maintain the HabitFlow service</li>
