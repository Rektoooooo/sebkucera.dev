      ...
      <div ref={ref} style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        ...
        >
          ...
          >
            ...
            />
            <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/images/HabitFlowPremium.png`} alt="Habit Owl" fill style={{ objectFit: 'contain' }} />
          </motion.div>
          ...
          >
            Download Habit Owl today. Your owl companion is excited to help you become your best self.
          </p>
