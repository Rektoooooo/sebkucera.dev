...
export default function ModernNav({ logo, logoAlt = 'Logo' }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6" style={{ transform: 'translateZ(0)', willChange: 'transform' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between px-6 py-4 rounded-full border border-white/10 bg-black/40 backdrop-blur-xl">
            <a href="#" className="font-semibold bg-gradient-to-r from-purple-500 via-purple-400 to-blue-500 bg-clip-text text-transparent">
              sebkucera.dev
            </a>
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="mt-4 px-6 py-6 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl">
